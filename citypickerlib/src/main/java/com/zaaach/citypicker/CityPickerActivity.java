...
public class CityPickerActivity extends Activity implements View.OnClickListener {
    ...
    private TextView list_back_btn;
    ...
    private void initView() {
        ...
        list_back_btn = (TextView) findViewById(R.id.list_back_btn);
        list_back_btn.setOnClickListener(this);
    ...
    private void back(String city) {
        ...
        setResult(1, intent);
        this.finish();
        //      ToastUtils.showToast(this, "点击：" + city);
